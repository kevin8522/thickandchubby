    ...
    const fetchData = async () => {
      try {
        const { data } = await axios.get(
          `/api/products/search?page=${page}&query=${query}&category=${category}&birth=${birth}&body=${body}&country=${country}&age=${age}&order=${order}`
        );
  ...
  return (
    <div>
       ...
       <DesktopHeader /> 
            ...
            <span className='search_desktop_filter_results_text' >   {countProducts === 0 ? 'No' : countProducts} Results </span>
            </div>
            <div className='search_desktop_filter' >
              <div className='search_desktop_filter_left' >
                  ...
                  <select
                  className='search_desktop_filter_left_sort'
                    value={order}
                    onChange={(e) => {
                  ...
                  >
                    ...
                    <option value="newest">New Users</option>
        ...
        <>
            ...
            <div className='search_mobile_filter' >
              <div className='search_mobile_filter_left' >
                <span className='search_mobile_filter_left_results' >{countProducts === 0 ? 'No' : countProducts} Results</span>
              </div>
